...
const FeaturedDestination = () => {
    ...
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
            ...
            <Title title='Featured Destination' subTitle='Step into a world of extraordinary stays—our global selection of premium properties promises comfort, style, and lasting memories.' />
