...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title title='My Bookings' subTitle='Effortlessly track your past, current, and upcoming hotel bookings—all in one convenient place. Plan your travels with ease and confidence in just a few clicks.' align='left' />

            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-bae py-3'>
