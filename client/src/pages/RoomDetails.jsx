    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col lg:flex-row mt-6 gap-6'>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w1/2 w-full'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                <div className='flex flex-col'>
                    <h1 className='text-3xl md:text-4xl font-playfair'>Redefine Your Luxury Experience</h1>
            ...
            <div>
                <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>Guests will be allocated to ground floor units based on availability. Enjoy a comfortable two-bedroom apartment that captures the essence of city living. The listed price covers two guests. For group bookings, please select the correct number of guests at the time of reservation to receive accurate pricing.</p>
            </div>
